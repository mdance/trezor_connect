...
/**
 * @file
 * Contains \Drupal\trezor_connect\Form\DisableForm.
 */
...
/**
 * Provides the disable authentication device confirmation form.
 */
class DisableForm extends ConfirmFormBase {
  ...
  public function getQuestion() {
    ...
    $output = $this->t('Are you sure you want to disable the authentication device for %target?', $args);
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $message = $this->t('The authentication device has been disabled for %target.', $args);
