...
class SettingsForm extends ConfigFormBase {
   ...
   */
  public function __construct(ConfigFactoryInterface $config_factory, StateInterface $state, $mapping_backends, $mapping_backend, TrezorConnectInterface $trezor_connect) {
